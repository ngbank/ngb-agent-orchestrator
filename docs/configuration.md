...
The same value is set in [config/litellm.yaml](../config/litellm.yaml), the reference config used when running the proxy standalone for development (`litellm --config config/litellm.yaml --port 4000`).
