...
of `recipes/generate_code.yaml` and any future Goose recipes in this project.
...
Both `recipes/generate_code.yaml` and `recipes/plan.yaml` were originally written with `response:`
