...
def test_logs_reads_from_xdg_default_base_dir(test_db, cli_runner, monkeypatch):
...
def test_logs_uses_explicit_logs_dir_override(test_db, cli_runner, monkeypatch):
