...
Promote / reject / edit-scope modals land in ticket 3.5.  This module
provides the shared ``ConfirmModal`` and ``InputModal`` that those modals
will use, mirroring ``dispatcher/tui/modals.py``.
"""
